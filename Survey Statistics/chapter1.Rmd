...
One of the main concepts of survey statistics is sampling weights. The formula for sampling weights is $$ sampling weight=\frac{1}{\pi_i} $$ Where $\pi_i$ is the probability of person *i* being sampled.
...
-Using the Horvits-Thompson Estimator and set the variable `{r} totalScore` equal to the estimtated total score of the school.
-Estimate the average score for the school.

*** =hint
The Horvits-Thompson Estimator formula in *R* code looks like `{r} sum(samplingWeight*score)`
...
totalScore<-sum(_____)

# Estimate the average for the whole school. Remember there are 1000 students
scoreAverage<-_____
...
# Assign the sum of the students' scores multiplied by their weights
totalScore<-sum(schoolkids$score*schoolkids$samplingWeight)

# Estimate the average for the whole school. Remember there are 1000 students
scoreAverage<-totalScore/1000
