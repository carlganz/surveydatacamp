...
The standard error is the square root of the variance. You can build 95% confidence intervals by addind and substracting $1.96*standard error$ from the total estimate.
...
The R `{r} survey` package was designed by Thomas Lumley to make tasks like the one you did earlier much easier.
